...
| `/emergency_stop` (`std_srvs/SetBool`) | `mujoco_ros2_plugins`: while enabled the pan-tilt holds its position and ignores commands, as on the real robot; releasing hands control back |
