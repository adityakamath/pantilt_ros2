...
URDF/xacro model of the Pan Tilt 100 mechanism (two STS3215 servos and an OAK-D S2 camera), its meshes, and a launch file for viewing it. The same files describe the standalone pan-tilt and the module that other robots embed. Everything else in the repository, including the MuJoCo model, is generated from this description.
